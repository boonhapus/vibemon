...
from app.domains.battle.mechanics import status, targeting, turn_order
from app.domains.battle.move_resolver import MoveResolver
...
class GameEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._move_resolver = MoveResolver(self._rng)
    ...
    def _execute_move_use(self, ctx: turn.Turn, use: turn.MoveUse) -> None:
        ctx.events.extend(self._move_resolver.resolve(ctx, use))
